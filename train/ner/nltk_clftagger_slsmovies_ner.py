...
MODEL_META = {
    "corpus": "MIT Movie Corpus",
    "lang": "en",
    "corpus_homepage": "https://groups.csail.mit.edu/sls/downloads/",
    "model_id": "nltk_clftagger_slsmovies_NER",
    "tagset": "conll_iob",
    "algo": "ClassifierBasedTagger | NamedEntityChunker",
    "entitíes": ['TITLE', 'ACTOR', 'DIRECTOR', 'SONG',
                 'RATINGS_AVERAGE', 'RATING', 'TRAILER', 'REVIEW',
                 'PLOT', 'YEAR', 'GENRE', 'CHARACTER'],
...
corpus_file = "/home/user/my_code/OpenJarbas/nlp_models/SLS/mit_movies/engtrain.bio"
reader = read_sls(corpus_file)
training_samples = list(reader)

corpus_file = "/home/user/my_code/OpenJarbas/nlp_models/SLS/mit_movies/engtest.bio"
reader = read_sls(corpus_file)
