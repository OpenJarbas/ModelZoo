...
MODEL_META = {
    ...
    "model_id": "nltk_clftagger_paramopama_NER",
    "tagset": "conll_iob",
...
corpus_root = "/home/user/my_code/OpenJarbas/nlp_models/NER-datasets/Portuguese/Paramopama/corpus_Paramopama.txt"
...
def train():
    ...
    path = join(dirname(dirname(dirname(__file__))),
                "models", "ner", "nltk_clftagger_paramopama_NER.pkl")
