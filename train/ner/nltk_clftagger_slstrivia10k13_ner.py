...
MODEL_META = {
    "corpus": "MIT Movie Corpus - Trivia",
    "lang": "en",
    "corpus_homepage": "https://groups.csail.mit.edu/sls/downloads/",
    "model_id": "nltk_clftagger_slstrivia10k13_NER",
    "tagset": "conll_iob",
    "algo": "ClassifierBasedTagger | NamedEntityChunker",
    "entitíes": ['Director', 'Genre', 'Year', 'Origin', 'Relationship',
                 'Character_Name', 'Quote', 'Actor', 'Opinion', 'Award',
                 'Soundtrack', 'Plot'],
...
corpus_file = "/home/user/my_code/OpenJarbas/nlp_models/SLS/mit_movies/trivia10k13train.bio"
reader = read_sls(corpus_file)
training_samples = list(reader)

corpus_file = "/home/user/my_code/OpenJarbas/nlp_models/SLS/mit_movies/trivia10k13test.bio"
reader = read_sls(corpus_file)
